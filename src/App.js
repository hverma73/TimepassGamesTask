...
const App = () => {
  ...
  const steps = [
    { component: <YourInfo goNext={goNext} />, label: "Your Info" },
    { component: <SelectPlan goNext={goNext} goBack={goBack} />, label: "Select Plan" },
    { component: <PickAdd goNext={goNext} goBack={goBack} />, label: "Add-Ons" },
    { 
      component: (
        <Summary
        ...
        <div className="flex-1 p-8">
          ...
          {isConfirmed ? (
            <div className="text-center">
              ...
              <h1 className="text-3xl font-semibold mt-4">Thank You!</h1>
              <p className="text-lg mt-2">
                We appreciate your purchase. You will receive an email with your order details shortly.
              </p>
            </div>
          ) : (
